      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <div className="text-lg text-gray-300 space-y-4 mb-8 min-h-[250px] sm:min-h-[300px]">
          <p className="leading-relaxed">
            <strong>Fadi Dabboura</strong>’s <strong>Website Scan Service</strong> provides a comprehensive analysis of your
            website’s performance, identifying issues that impact user experience and search engine
            rankings.
          </p>
          <p className="leading-relaxed">
            Using advanced tools, <strong>Fadi Dabboura</strong> evaluates <strong>page speed</strong>, <strong>SEO</strong>,{' '}
            <strong>security</strong>, and <strong>accessibility</strong>. The scan delivers actionable
            recommendations to optimize your site.
          </p>
          <p className="leading-relaxed">
            Get personalized support from <strong>Fadi Dabboura</strong> to address critical issues. Start with my{' '}
            <Link
              href="/website-scan"
        ...
        >
          Start Fadi Dabboura’s Website Scan Now
        </Link>
      </div>
    </Section>
  );
