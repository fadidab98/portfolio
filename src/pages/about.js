  ...
  return (
    <div>
      ...
      <section className="py-16 px-4 max-w-2xl mx-auto">
        ...
        <p className="text-lg">
          I’m a passionate full-stack developer with expertise in Next.js and a flair for creating
          innovative, user-focused solutions. My journey blends technical precision with creative
